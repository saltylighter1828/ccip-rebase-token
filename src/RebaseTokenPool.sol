...
import {
    IPoolV1
} from "lib/chainlink-brownie-contracts/contracts/src/v0.8/ccip/interfaces/IPool.sol";
...
import {
    Pool
} from "lib/chainlink-brownie-contracts/contracts/src/v0.8/ccip/libraries/Pool.sol";
...
contract RebaseTokenPool is TokenPool {
    ...
    function lockOrBurn(
        ...
        uint256 userInterestRate = IRebaseToken(address(i_token))
            .getUserInterestRate(originalSender); //can't cast interface directly to another. so need to cast address
